...
If you find a security vulnerability in fue, please report it through [GitHub's private vulnerability reporting](https://github.com/sebastian-linden/fue/security/advisories/new). This keeps the details private while we work on a fix.
...
**Enterprise support** is available, with priority response SLAs. Contact sebastian.bennet.linden@rwth-aachen.de for details.

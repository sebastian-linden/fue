...
The Forecast Uncertainty Estimation (pyfue) package comes with a built-in Command Line Interface (CLI) powered by Typer. It gives you terminal-based execution for all the core pipeline tasks: fetching data, checking your inventory, training models, and generating those final uncertainty bounds.
...
.. code-block:: bash
   ...
   pyfue dataset-summary --threshold 150
...
.. code-block:: bash
   ...
   pyfue train --model ml --layers "16,8" --alpha 0.01
...
.. code-block:: bash
   ...
   pyfue forecast --city aachen --days 7
...
.. code-block:: bash
   ...
   pyfue forecast --city aachen --days 7 --plot
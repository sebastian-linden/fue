...
class TestMLUncertaintyModel:
    ...
    def test_init(self):
        ...
        model = MLUncertaintyModel(hidden_layer_sizes=(64, 32), max_iter=1000, alpha=0.05, ensemble_size=10, seed=123)
    ...
    def test_predict_internal_unfitted_raises_error(self):
    ...
    def test_predict_internal_averaging_and_clipping(self):
        """Test that predictions are correctly averaged across the ensemble and clipped."""
        model = MLUncertaintyModel(ensemble_size=2)
